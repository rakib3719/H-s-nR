...
//             {/* Other Fields */}
//             {/* Include other fields as in the original code */}
...
//               animate={{ opacity: 1 }}
//               transition={{ duration: 1, delay: 1 }}
//               className={`w-full py-4 mt-8 ${loader ? 'bg-gray-400' : 'bg-yellow-500'} text-white text-lg font-semibold rounded-lg hover:bg-yellow-600 transition-all`}
//             >
//               {loader ? 'Adding Room...' : 'Add Room'}
//             </motion.button>
//           </motion.div>
