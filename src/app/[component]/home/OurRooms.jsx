...
// const OurRooms = () => {
//   return (
//     <section className="bg-[#fff5ed] text-center py-10">
...
//       <div className="flex justify-center items-center min-h-screen bg-[#f9f1ec]">
//         <div className="group relative max-w-md w-full rounded-lg shadow-lg bg-white overflow-hidden">
//           {/* Image Section */}
//           <Image
//             width={533}
//             height={533}
//             src="https://themewant.com/products/wordpress/almaris/wp-content/uploads/2024/09/g_5-533x533.webp" // Replace with your image
//             alt="Studio Sanctuary"
//             className="object-cover w-full h-72"
//           />

//           {/* Default Content */}
//           <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-end p-6 opacity-100 transition-all duration-300 group-hover:opacity-0">
//             <div className="text-white">
//               <h1 className="text-2xl font-bold">Studio Sanctuary</h1>
//               <p className="mt-1">2 Guests · 35 Feet Size</p>
//             </div>
//           </div>
...
//       price: "$50",
//       image:
//         "https://themewant.com/products/wordpress/almaris/wp-content/uploads/2024/09/g_5-533x533.webp",
//     },
//     {
//       id: 2,
//       name: "Urban Loft",
