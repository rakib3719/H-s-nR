...
//   const [checkInDate, setCheckInDate] = useState(data.availableFrom);
//   const [checkOutDate, setCheckOutDate] = useState("");
//   const [guests, setGuests] = useState({
//     adults: 0,
//     children: 0,
...
//         <h2 className="text-gray-500 text-sm font-medium">Rent Sale</h2>
//         <p className="text-pink-500 text-2xl font-bold mt-2">
//           BDT {data.price}<span className="text-base font-normal text-gray-600">/day</span>
//         </p>
//       </div>
...
//                 //   ? new Date(data.availableFrom).toLocaleDateString('en-US'): checkInDate.toLocaleDateString('en-US') }
//                 onChange={(e) => setCheckInDate(e.target.value)}
//                 className="w-full border-none outline-none text-sm text-gray-800"
//               />
//             </div>
